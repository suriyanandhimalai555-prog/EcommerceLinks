...
// FilterStatus includes 'awaiting' (pending + has submitted docs) as a read-only filter.
// KycStatus is the set of values that can actually be persisted via the decide mutation.
